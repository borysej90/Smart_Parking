...
class ParkingLotSerializer(serializers.ModelSerializer):
    ...
    video_processor_id = serializers.PrimaryKeyRelatedField(source='video_processor',
                                                            queryset=VideoProcessor.objects.all())

    class Meta:
        model = ParkingLot
        fields = ['id', 'position_on_board', 'shape_on_board', 'coordinates', 'is_occupied', 'parking_site_id',
                  'video_processor_id', 'is_for_disabled']
